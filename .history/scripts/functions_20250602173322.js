...
item.priority = 'נמוכה';
3 // הגדרת ברירת מחדל לעדיפות נמוכה
item.priority = 'בינונית'; // הגדרת ברירת מחדל לעדיפות נמוכה
2
item.priority = 'גבוהה'; // הגדרת ברירת מחדל לעדיפות נמוכה
1
    ...
    for (let i = 0; i < size - 1; i++) {
        for (let j = 0; j < size - i - 1; j++) {
            if (itemsList[j].priority = 'נמוכה')
                itemsList[j].priority = 3;
            if (itemsList[j].priority = 'בינונית')
                itemsList[j].priority = 2;
            if (itemsList[j].priority = 'גבוהה')
                itemsList[j].priority = 1;
            if (itemsList[j].priority > itemsList[j + 1].priority) {
                let temp = itemsList[j];
                itemsList[j] = itemsList[j + 1];
                itemsList[j + 1] = temp;
            }
